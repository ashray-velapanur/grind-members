...
<head> 
  ...
  <script>window.jQuery || document.write("<script src='<?= get_bloginfo('stylesheet_directory'); ?>/js/libs/jquery-1.6.2.min.js'>\x3C/script>")</script>
<?php
...
<form name="login_form" id="login_form" action="<?php echo site_url('wp-login.php', 'login_post') ?>" method="post">
	<p>
...
<?php do_action('login_form'); ?>
	...
	<p class="submit">
		<button type="submit" name="wp-submit" id="wp-submit" class="btn" tabindex="100" />Sign in &amp; conquer</button>
...
<?php if ( !$interim_login ) { ?>
<p><a href="<?php echo site_url('wp-login.php?action=lostpassword', 'login') ?>" title="<?php _e('Password Lost and Found') ?>"><?php _e('Forgot your password?') ?></a></p>
