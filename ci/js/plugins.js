...
function disablePopup(popupDivId){
  if(popupStatus==1){
...
function centerPopup(popupDivId){
  $("body").append($(popupDivId));
  var windowWidth = $(window).width();
  var windowHeight = $(window).height();
  var popupHeight = $(popupDivId).height();
  var popupWidth = $(popupDivId).width();
  $(popupDivId).css({ "top": windowHeight/2-popupHeight/2, "left": windowWidth/2-popupWidth/2});
}
