...
<?= $form ?>
	<div id="misc_editor">
		...
		<?
			...
			$attributes = array('name'=>'subject','id'=>'subject','value'=>stripslashes($template->subject),'class'=>'email_template_input required');
			echo form_input($attributes);
		?>
		</div>
		...
		<?
			...
			$attributes = array('name'=>'message','id'=>'subject','value'=>stripslashes($template->message),'class'=>'email_template_input required');
