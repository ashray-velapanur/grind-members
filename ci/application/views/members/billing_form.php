 ...
 */
 ...
 $date = getdate();
 $exp_year = isset($billing_info->year) ? $billing_info->year : ""; 
 $exp_month = isset($billing_info->month) ? $billing_info->month: ($date["mon"] - 1); 

?>

<div class="editItemContainer clearfix"> 	
      <form id="billingInfo-form" rel="billingInfoBlock" action="<?=site_url('ci/billing/account/updateBilling/')?>">
