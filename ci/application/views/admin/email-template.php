...
<body style="margin:0;background:#babcbe;">
  <table width="100%" height="100%" cellpadding="0" cellspacing="37" border="0" bgcolor="#babcbe"><tr><td align="center">
    <table width="538" border="0" cellspacing="0" cellpadding="0" style="background:#fff;font-size: 12px;font-family:arial,sans-serif;line-height:1.231;color:#444;">
      <tr>
        <td><img src="http://grindspaces.com/main/email/generic-head.png" width="538" height="123" alt="grind" style="display:block;border:0;"></td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td><img src="http://grindspaces.com/email/white-border-bottom.png" width="538" height="6" alt="" style="display:block;border:0;"></td>
      </tr>
    </table>
  </td></tr></table>
</body>
