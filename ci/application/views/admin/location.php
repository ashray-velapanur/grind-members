    ...
    <ul>
		...
		<li>
		  ...
		  <?=form_input(array("id" => "wlc_ip", "name" => "wlc_ip", "value" => (isset($location) ? $location->wlc_ip : ""))) ?>
                ...
                <li>
                  <label for="charge_message">Charge Message (e.g. CHK-PA)</label>
                  <?=form_input(array("id" => "charge_message", "name" => "charge_message", "value" => (isset($location) ? $location->charge_message : ""))) ?>
                </li>
		</ul>
  </fieldset>
