<?=g_form('admin/usermanagement/updateprofile','post',array('id' => 'register','class'=>'clearfix'))?>
  ...
  <fieldset>
    ...
    <ul>
      ...
      <li>
          ...
          <select id="location_id" name="location_id" title="Location">
...
<script type="text/javascript">
    $(function() {
		...
		$("#register #primary_email").rules("add", {
		  remote: '<?=site_url("ci/admin/utility/uniqueEmail")?>',
		  messages: {
