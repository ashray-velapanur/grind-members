 ...
 */
    public function inbound() {
        ...
        $this->notification = new Recurly_PushNotification($post_xml);
 ...
 */ 
    private function subscription_to_array() {
        log_message("debug","setting up data");
         ...
         $activated_at = new DateTime($subscription->activated_at);
         $data["activated_at"] = $subscription->activated_at!="" ?  $activated_at->format('Y-m-d H:i:s') : null;   
         $canceled_at = new DateTime($subscription->canceled_at);
         $data["canceled_at"] = $subscription->canceled_at!="" ?  $canceled_at->format('Y-m-d H:i:s') : null;
         $expires_at = new DateTime($subscription->expires_at);
         $data["expires_at"] = $subscription->expires_at!="" ? $expires_at->format('Y-m-d H:i:s') : null;
         $current_period_started_at = new DateTime($subscription->current_period_started_at);
         $data["current_period_started_at"] = $subscription->current_period_started_at!="" ?  $current_period_started_at->format('Y-m-d H:i:s') : null;
         $current_period_ends_at = new DateTime($subscription->current_period_ends_at);
         $data["current_period_ends_at"] = $subscription->current_period_ends_at!="" ? $current_period_ends_at->format('Y-m-d H:i:s') : null;
         $trial_started_at = new DateTime($subscription->trial_started_at);
         $data["trial_started_at"] = $subscription->trial_started_at!="" ? $trial_started_at->format('Y-m-d H:i:s') : null;
         $trial_ends_at = new DateTime($subscription->trial_ends_at);
         $data["trial_ends_at"] = $subscription->trial_ends_at!="" ? $trial_ends_at->format('Y-m-d H:i:s') : null;
