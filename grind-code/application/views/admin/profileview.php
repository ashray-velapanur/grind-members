...
<script type="text/javascript" src="<?=ROOTMEMBERPATH?>grind-code/js/admin_profile_temp.js"></script>
<script type="text/javascript">
	var profileData = '<?= json_encode($user) ?>';
	var billingData = '<?= json_encode($billingData) ?>';
	var recurlyAccount = '<?= json_encode($recurlyAccount) ?>';
	var recurlySubscription = '<?= json_encode($recurlyPlan) ?>';
</script>
<div id="sidebar" class="member-recent">
	<h4>Recent Charges & Credits</h4> <a href="#">Add Charge</a>
	<ul class="minitable">
		<li class="clearfix">
			<div class="type-date">
				<div id="trans-type">Transaction type</div>
				<div class="datetime">MM/DD/YY HH:MM AM</div>
			</div>
	...
	<h4>Recent Checkins</h4> <a href="#">Add Charge</a>
	<ul class="minitable">
		<li>
		  <div class="datetime">MM/DD/YY HH:MM AM</div>			
			<div class="checkin-location clearfix">Grind Park Ave</div>
		</li>
		<li>
		  <div class="datetime">MM/DD/YY HH:MM AM</div>
			<div class="checkin-location clearfix">Grind Park Ave</div>
...
<div>
	...
	<div class="formContainer" id="profile-container">
			<div class="profileSection" id="memberInfoSection">
				<div class="itemContainer" id="fullNameBlock">
					...
					<div class="editItemContainer clearfix">
						<form id="fullName-form" rel="fullNameBlock" class="clearfix">
							<input type="hidden" id="wp_users_id" name="wp_users_id" value="<?php echo $user->id; ?>"/>
				...
				<div class="itemContainer" id="emailBlock">
					<div class="roItemContainer">
						...
						<p class="formNote">this is also their username</p>
					</div>
					<div class="editItemContainer clearfix">
				...
				<div class="itemContainer" id="companyNameBlock">
					...
					<div class="editItemContainer clearfix"> 
						<form id="phone-form" rel="phoneBlock" class="clearfix">
							<input type="hidden" id="wp_users_id" name="wp_users_id" value="<?php echo $user->id; ?>"/>
							<div class="floatingFormItem">
								<input class="text-input phone" name="phone" type="text" id="phone" value="" />
			...
			<div class="profileSection" id="membershipSection">
		        ...
		        ?>
		            <option value="<?=$plan->plan_code?>"  <?= $recurlyPlan->membership_plan_code == $plan->plan_code ? "selected" : ""?>><?=$plan->name ?></option>
		        <? } ?>
		        </select>
		        <?
		        if (isset($user)) {
