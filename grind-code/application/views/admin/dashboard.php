...
include_once(MEMBERINCLUDEPATH . "/grind-code/application/libraries/recurlyaccess.php");
...
<div id="dashboard">
  ...
  <aside id="sidebar">
    <section id="member-search">
      <form action="<?=site_url('grind-code/admin/usermanagement/search')?>" method="post">
    ...
    <section id="access-pricing">
      ...
      <form action="<?=site_url('grind-code/index.php/admin/locationmanagement/updateaccesspricing')?>" method="post">
