$(function() {
	...
	$("#waitlist-form,#companyDescription-form,#rfid-form,#email-form,#phone-form,#twitter-form, #behance-form, #website-form, #companyName-form, #fullName-form").submit(function(){
	  var itemContainerId = $(this).attr("rel");
