 ...
 */
function ecpt_wp_tiny_mce( $teeny = false, $settings = false ) {
        ...
        */
        ...
        if ( $teeny ) {
                ...
                $mce_buttons = apply_filters('mce_buttons', array('bold', 'italic', 'strikethrough', '|', 'bullist', 'numlist', 'blockquote', '|', 'justifyleft', 'justifycenter', 'justifyright', '|', 'link', 'unlink', 'wp_more', '|', 'spellchecker', 'wp_adv' ));
                $mce_buttons = implode($mce_buttons, ',');
        ...
        $initArray = array (
                ...
                'extended_valid_elements' => 'p[*],article[*],aside[*],audio[*],canvas[*],command[*],datalist[*],details[*],embed[*],figcaption[*],figure[*],footer[*],header[*],hgroup[*],keygen[*],mark[*],meter[*],nav[*],output[*],progress[*],section[*],source[*],summary,time[*],video[*],wbr',
