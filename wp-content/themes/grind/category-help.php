...
?>
<?php query_posts('category_name='.single_cat_title( '', false).'&posts_per_page=-1&orderby=meta_value_num&meta_key=SortOrder&order=ASC'); ?>
...
?>
	...
	<div id="instructions">
		...
		<div id="sendHelpFormBlock">
			<?=g_form("/ci/admin/utility/SendHelpMail/".$user_ID."/".UserIdType::WORDPRESSID,'post',array('id'=>'sendHelpForm','class'=>'grey-fields','id'=>'sendHelpForm'))?>
